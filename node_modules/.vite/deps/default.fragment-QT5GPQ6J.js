...
import "./chunk-PQHZOLM5.js";
import "./chunk-T5VKEAT2.js";
import "./chunk-ZNKC323Q.js";
import "./chunk-3EAOHZB6.js";
import {
  ShaderStore
...
var name3 = "lightUboDeclaration";
var shader3 = `#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
var name4 = "ltcHelperFunctions";
var shader4 = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
var name5 = "lightsFragmentFunctions";
var shader5 = `struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
var name6 = "shadowsFragmentFunctions";
var shader6 = `#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
var name7 = "samplerFragmentDeclaration";
var shader7 = `#ifdef _DEFINENAME_
...
var name8 = "fresnelFunction";
var shader8 = `#ifdef FRESNEL
...
var name9 = "reflectionFunction";
var shader9 = `fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
var name10 = "imageProcessingDeclaration";
var shader10 = `#ifdef EXPOSURE
...
var name11 = "imageProcessingFunctions";
var shader11 = `#if TONEMAPPING==3
...
var name12 = "bumpFragmentMainFunctions";
var shader12 = `#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
var name13 = "bumpFragmentFunctions";
var shader13 = `#if defined(BUMP)
...
var name14 = "bumpFragment";
var shader14 = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
var name15 = "decalFragment";
var shader15 = `#ifdef DECAL
...
var name16 = "depthPrePass";
var shader16 = `#ifdef DEPTHPREPASS
...
var name17 = "lightFragment";
var shader17 = `#ifdef LIGHT{X}
...
var name18 = "logDepthFragment";
var shader18 = `#ifdef LOGARITHMICDEPTH
...
var name19 = "oitFragment";
var shader19 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
var name20 = "defaultPixelShader";
var shader20 = `#include<defaultUboDeclaration>
...
`;
if (!ShaderStore.ShadersStoreWGSL[name20]) {
  ShaderStore.ShadersStoreWGSL[name20] = shader20;
}
var defaultPixelShaderWGSL = { name: name20, shader: shader20 };
export {
  defaultPixelShaderWGSL
};
//# sourceMappingURL=default.fragment-QT5GPQ6J.js.map
