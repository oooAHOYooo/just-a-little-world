...
import {
  PerfCounter
} from "./chunk-AEUOHBRM.js";
import {
  Frustum
} from "./chunk-LW2GVCCW.js";
import {
  LightConstants,
  UniformBuffer
...
var WebDeviceInputSystem = class {
  ...
  _handlePointerActions() {
    ...
    this._pointerCancelTouch = (pointerId) => {
      ...
      if ((_b = (_a = this._elementToAttachTo).hasPointerCapture) == null ? void 0 : _b.call(_a, pointerId)) {
...
var Scene = class _Scene {
  ...
  bindEyePosition(effect, variableName = "vEyePosition", isVector3 = false) {
    var _a;
    const eyePosition = this._forcedViewPosition ? this._forcedViewPosition : this._mirroredCameraPosition ? this._mirroredCameraPosition : ((_a = this.activeCamera) == null ? void 0 : _a.globalPosition) ?? Vector3.ZeroReadOnly;
  ...
  _renderWithFrameGraph(updateCameras = true, ignoreAnimations = false) {
    ...
    (_a = this.frameGraph) == null ? void 0 : _a.execute();
  }
  /**
   * Render the scene
...
//# sourceMappingURL=chunk-K4P5CXLI.js.map
