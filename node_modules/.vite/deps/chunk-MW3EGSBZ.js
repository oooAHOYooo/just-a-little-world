...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-CD56HE4I.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-HBFAPS7N.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-VSM7HHTP.js")]));
    }
  }
  /**
...
//# sourceMappingURL=chunk-MW3EGSBZ.js.map
