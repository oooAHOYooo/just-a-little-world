...
var name3 = "lightFragmentDeclaration";
...
var name4 = "lightUboDeclaration";
var shader4 = `#ifdef LIGHT{X}
uniform Light{X}
...
var name5 = "samplerFragmentDeclaration";
var shader5 = `#ifdef _DEFINENAME_
...
var name6 = "imageProcessingDeclaration";
var shader6 = `#ifdef EXPOSURE
...
var name7 = "imageProcessingFunctions";
var shader7 = `#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
var name9 = "bumpFragmentMainFunctions";
var shader9 = `#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
var name10 = "bumpFragmentFunctions";
var shader10 = `#if defined(BUMP)
...
var name11 = "reflectionFunction";
var shader11 = `vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
var name12 = "decalFragment";
var shader12 = `#ifdef DECAL
#ifdef GAMMADECAL
...
var name13 = "bumpFragment";
var shader13 = `vec2 uvOffset=vec2(0.0,0.0);
...
var name14 = "depthPrePass";
var shader14 = `#ifdef DEPTHPREPASS
...
var name15 = "lightFragment";
var shader15 = `#ifdef LIGHT{X}
...
var name17 = "oitFragment";
var shader17 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
var name18 = "decalFragmentDeclaration";
...
var name19 = "ltcHelperFunctions";
var shader19 = `vec2 LTCUv( const in vec3 N,const in vec3 V,const in float roughness ) {const float LUTSIZE=64.0;const float LUTSCALE=( LUTSIZE-1.0 )/LUTSIZE;const float LUTBIAS=0.5/LUTSIZE;float dotNV=saturate( dot( N,V ) );vec2 uv=vec2( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
//# sourceMappingURL=chunk-R7DM5L4M.js.map
