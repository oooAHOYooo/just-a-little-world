import "./chunk-IKEWDG34.js";
import "./chunk-AH7BWOAE.js";
import "./chunk-M53QMGBN.js";
import "./chunk-3PJU5P3W.js";
import "./chunk-KXXJY7AE.js";
import {
  ShaderStore
...
var shader2 = `uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
var name4 = "oitDeclaration";
var shader4 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
// node_modules/@babylonjs/core/Shaders/ShadersInclude/ltcHelperFunctions.js
var name7 = "ltcHelperFunctions";
var shader7 = `vec2 LTCUv( const in vec3 N,const in vec3 V,const in float roughness ) {const float LUTSIZE=64.0;const float LUTSCALE=( LUTSIZE-1.0 )/LUTSIZE;const float LUTBIAS=0.5/LUTSIZE;float dotNV=saturate( dot( N,V ) );vec2 uv=vec2( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
var name8 = "lightsFragmentFunctions";
var shader8 = `struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
var name9 = "shadowsFragmentFunctions";
var shader9 = `#ifdef SHADOWS
...
var name10 = "samplerFragmentDeclaration";
var shader10 = `#ifdef _DEFINENAME_
...
var name11 = "fresnelFunction";
var shader11 = `#ifdef FRESNEL
...
var name12 = "reflectionFunction";
var shader12 = `vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
var name13 = "imageProcessingDeclaration";
var shader13 = `#ifdef EXPOSURE
...
var name14 = "imageProcessingFunctions";
var shader14 = `#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
var name15 = "bumpFragmentMainFunctions";
var shader15 = `#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name15]) {
...
var name16 = "bumpFragmentFunctions";
var shader16 = `#if defined(BUMP)
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name22]) {
  ShaderStore.IncludesShadersStore[name22] = shader22;
}

// node_modules/@babylonjs/core/Shaders/default.fragment.js
var name23 = "defaultPixelShader";
var shader23 = `#define CUSTOM_FRAGMENT_EXTENSION
...
`;
if (!ShaderStore.ShadersStore[name23]) {
  ShaderStore.ShadersStore[name23] = shader23;
}
var defaultPixelShader = { name: name23, shader: shader23 };
export {
  defaultPixelShader
};
//# sourceMappingURL=default.fragment-DXZS2B5F.js.map
