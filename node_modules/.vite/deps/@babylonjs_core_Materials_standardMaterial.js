import {
  Material,
  PushMaterial
} from "./chunk-XDB4YQP6.js";
import "./chunk-D6TYAGYM.js";
import {
  ImageProcessingConfiguration,
  Scene
} from "./chunk-3RB72RCC.js";
      ...
      let effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-46NBV6SV.js"), import("./default.fragment-7TUFT5HG.js")]);
          } else {
            await Promise.all([import("./default.vertex-VEP3YBNP.js"), import("./default.fragment-DXZS2B5F.js")]);
          }
