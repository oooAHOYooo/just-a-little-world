import "./chunk-R7DM5L4M.js";
import "./chunk-JEQ6G3LT.js";
import "./chunk-OW7YCHXZ.js";
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name23]) {
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name24]) {
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name25]) {
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name26]) {
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name27]) {
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name28]) {
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name29]) {
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name30]) {
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name31]) {
...
var shader32 = `vec3 finalDiffuse=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;
if (!ShaderStore.IncludesShadersStore[name32]) {
...
`;
if (!ShaderStore.IncludesShadersStore[name33]) {
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name34]) {
  ShaderStore.IncludesShadersStore[name34] = shader34;
}

// node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockPrePass.js
var name35 = "pbrBlockPrePass";
var shader35 = `float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name36]) {
  ShaderStore.IncludesShadersStore[name36] = shader36;
}

// node_modules/@babylonjs/core/Shaders/pbr.fragment.js
var name37 = "pbrPixelShader";
var shader37 = `#define CUSTOM_FRAGMENT_EXTENSION
...
`;
if (!ShaderStore.ShadersStore[name37]) {
  ShaderStore.ShadersStore[name37] = shader37;
}
var pbrPixelShader = { name: name37, shader: shader37 };
export {
  pbrPixelShader
};
//# sourceMappingURL=pbr.fragment-VTYBDSUX.js.map
