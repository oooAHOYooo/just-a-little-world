...
import "./chunk-PPJEDYIJ.js";
import "./chunk-NLLIRGAK.js";
...
var name = "decalVertexDeclaration";
...
var name2 = "defaultVertexDeclaration";
var shader2 = `uniform mat4 viewProjection;
#ifdef MULTIVIEW
...
var name3 = "uvAttributeDeclaration";
var shader3 = `#ifdef UV{X}
attribute vec2 uv{X};
#endif
`;
...
var name4 = "prePassVertexDeclaration";
var shader4 = `#ifdef PREPASS
...
var name5 = "samplerVertexDeclaration";
var shader5 = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
var name6 = "bumpVertexDeclaration";
var shader6 = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
var name7 = "lightVxFragmentDeclaration";
var shader7 = `#ifdef LIGHT{X}
...
var name8 = "lightVxUboDeclaration";
...
var name9 = "prePassVertex";
var shader9 = `#ifdef PREPASS_DEPTH
...
var name10 = "uvVariableDeclaration";
var shader10 = `#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
...
var name11 = "samplerVertexImplementation";
var shader11 = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
var name12 = "bumpVertex";
var shader12 = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
...
var name14 = "pointCloudVertex";
var shader14 = `#if defined(POINTSIZE) && !defined(WEBGPU)
...
var name15 = "logDepthVertex";
var shader15 = `#ifdef LOGARITHMICDEPTH
...
var name16 = "defaultVertexShader";
var shader16 = `#define CUSTOM_VERTEX_EXTENSION
...
if (!ShaderStore.ShadersStore[name16]) {
  ShaderStore.ShadersStore[name16] = shader16;
}
var defaultVertexShader = { name: name16, shader: shader16 };
export {
  defaultVertexShader
};
//# sourceMappingURL=default.vertex-VEP3YBNP.js.map
