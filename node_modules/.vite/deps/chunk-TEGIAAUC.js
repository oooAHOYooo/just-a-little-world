...
var name4 = "samplerFragmentDeclaration";
var shader4 = `#ifdef _DEFINENAME_
...
var name5 = "imageProcessingDeclaration";
var shader5 = `#ifdef EXPOSURE
...
var name6 = "imageProcessingFunctions";
var shader6 = `#if TONEMAPPING==3
...
var name7 = "shadowsFragmentFunctions";
var shader7 = `#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
var name8 = "bumpFragmentMainFunctions";
var shader8 = `#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
var name9 = "bumpFragmentFunctions";
var shader9 = `#if defined(BUMP)
...
var shader10 = `fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
var name11 = "decalFragment";
var shader11 = `#ifdef DECAL
...
var name12 = "bumpFragment";
var shader12 = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
var name13 = "depthPrePass";
var shader13 = `#ifdef DEPTHPREPASS
...
var name14 = "lightFragment";
var shader14 = `#ifdef LIGHT{X}
...
var name16 = "oitFragment";
var shader16 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
var name17 = "ltcHelperFunctions";
var shader17 = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
//# sourceMappingURL=chunk-TEGIAAUC.js.map
