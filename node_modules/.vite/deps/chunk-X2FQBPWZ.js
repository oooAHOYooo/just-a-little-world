    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-7KWL6DQQ.js"), import("./pbr.fragment-ARIJ43NJ.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-76H7MNS3.js"), import("./pbr.fragment-DIFW354O.js")]);
        }
...
//# sourceMappingURL=chunk-X2FQBPWZ.js.map
