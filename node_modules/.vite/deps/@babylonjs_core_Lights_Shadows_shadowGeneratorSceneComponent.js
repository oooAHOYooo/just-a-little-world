...
import "./chunk-D4W7VWIU.js";
import "./chunk-4E5KSSIT.js";
import {
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      ...
      await Promise.all([import("./depth.vertex-GYX3SRQ6.js"), import("./depth.fragment-3T7UVK5O.js")]);
    } else {
      await Promise.all([import("./depth.vertex-K7BTD5WG.js"), import("./depth.fragment-FQSNMR55.js")]);
    }
