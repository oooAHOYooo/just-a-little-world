...
} from "./chunk-U4PMGZ6X.js";
import {
  FlowGraphUnaryOperationBlock
} from "./chunk-OXRD4OL7.js";
import "./chunk-PHVKKKKV.js";
import {
  FlowGraphBlock,
  RichTypeBoolean,
  RichTypeMatrix,
...
var FlowGraphTransposeBlock = class extends FlowGraphUnaryOperationBlock {
  /**
...
var FlowGraphDeterminantBlock = class extends FlowGraphUnaryOperationBlock {
  /**
   * Creates a new instance of the block.
   * @param config the configuration of the block
   */
...
var FlowGraphInvertMatrixBlock = class extends FlowGraphUnaryOperationBlock {
  /**
...
var FlowGraphMatrixMultiplicationBlock = class extends FlowGraphBinaryOperationBlock {
  /**
...
var FlowGraphMatrixDecomposeBlock = class extends FlowGraphBlock {
  constructor(config) {
    super(config);
...
var FlowGraphMatrixComposeBlock = class extends FlowGraphBlock {
  constructor(config) {
    super(config);
...
//# sourceMappingURL=flowGraphMatrixMathBlocks-7OSVRGVS.js.map
