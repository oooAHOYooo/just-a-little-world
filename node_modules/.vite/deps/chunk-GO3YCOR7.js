...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRGBDTexture = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGPU) {
        await import("./rgbdDecode.fragment-6ZITDJOL.js");
      } else {
        await import("./rgbdDecode.fragment-WPECM6S4.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-LDGVU4QJ.js");
    } else {
      await import("./rgbdEncode.fragment-PVONAEX2.js");
    }
...
//# sourceMappingURL=chunk-GO3YCOR7.js.map
